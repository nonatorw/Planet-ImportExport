...
/**
 * Pure unit tests for the ADR-0004 version-N+1 merge rule: "fields(N+1) = fields(N) overridden by
 * any recognized fields present in the new row." No MongoDB or CDI container required.
 *
 * <p>Uses plain JUnit 5 assertions: AssertJ is not currently on the test classpath (not declared
 * in {@code build.gradle}) — see this task's final report for the flagged gap.
 */
class CustomerRecordVersionMergeTest {
    ...
    void firstVersion_hasNoPredecessor_usesIncomingFieldsAsGiven() {
        ...
        Map<String, Object> incomingRow = Map.of("name", "John Smith", "email", "john@example.com");

        Map<String, Object> merged = CustomerRecordVersionMerge.merge(previousVersionFields, incomingRow);
    ...
    void additiveField_notPresentBefore_isAddedWithoutLosingPriorFields() {
        Map<String, Object> previousVersionFields = Map.of("name", "John Smith", "country", "Portugal");
        Map<String, Object> incomingRow = Map.of("phone", "+351910000000");
    ...
    void conflictingValue_incomingRowWins_overPreviousVersion() {
        Map<String, Object> previousVersionFields = Map.of("country", "Portugal");
        Map<String, Object> incomingRow = Map.of("country", "Spain");
    ...
    void cumulativeThreeFileWorkedExample_unionOfAllFieldsEverSupplied_latestWinsOnOverlap() {
        ...
        Map<String, Object> version1 =
                CustomerRecordVersionMerge.merge(
                        Map.of(), Map.of("name", "John Smith", "country", "Portugal"));
        Map<String, Object> version2 =
                CustomerRecordVersionMerge.merge(version1, Map.of("phone", "+351910000000"));
        Map<String, Object> version3 = CustomerRecordVersionMerge.merge(version2, Map.of("country", "Spain"));
    ...
    void unrecognizedIncomingKey_isRejected() {
        ...
        assertTrue(exception.getMessage().contains("loyalty_tier"));
    }

    @Test
    void inputMaps_areNotMutated() {
        Map<String, Object> previousVersionFields = new LinkedHashMap<>(Map.of("name", "John Smith"));
        Map<String, Object> incomingRow = new LinkedHashMap<>(Map.of("country", "Portugal"));
